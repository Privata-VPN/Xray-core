...
type Config struct {
	...
	MaxReadFrameSize       int32                  `protobuf:"varint,30,opt,name=maxReadFrameSize,proto3" json:"maxReadFrameSize,omitempty"`
	DownlinkFlushChunkSize int32                  `protobuf:"varint,31,opt,name=downlinkFlushChunkSize,proto3" json:"downlinkFlushChunkSize,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *Config) GetDownlinkFlushChunkSize() int32 {
	if x != nil {
		return x.DownlinkFlushChunkSize
	}
	return 0
}
...
const file_transport_internet_splithttp_config_proto_rawDesc = "" +
	...
	"\x10maxReadFrameSize\x18\x1e \x01(\x05R\x10maxReadFrameSize\x126\n" +
	"\x16downlinkFlushChunkSize\x18\x1f \x01(\x05R\x16downlinkFlushChunkSize\x1a:\n" +
